...
Da einführende Beispiele für test-getriebene Entwicklung oftmals unbedfriedigend für den Leser sind, da sie isoliert betrachtet nicht der Komplexität realer Anwendungen gerecht werden, bezieht sich dieses Dokument auf ein studentisches Referenz-Projekt, welches parallel an der Hochschule der Medien entstanden ist. Bei dem studentischen Projekt [MorePeople](https://github.com/schreon/morepeople-android) handelt es sich um einen location-based Service in Form einer Android App. Mit MorePeople können spontane Aktivitäten gestartet werden, für die automatisch interessierte Teilnehmer aus der Umgebung gesucht werden. Für die Umsetzung ist ein Client- (Java/Android-Code) und ein Server-Teil (Python-Code) notwendig. Anhand dieses Projekts, das ebenfalls auf Github zur Verfügung steht, sollen die eingesetzten Techniken erläutert werden. Dies hat den Vorteil, dass die Leser Schritt für Schritt die Einrichtung und Verwendung einer automatisierten Testumgebung anhand eines realen Projekts nachvollziehen können. 
